...
def render_footer():
    ...
    <div class="footer-bottom">
        <p>Auteur : Nicolas Renard | Version de l\'application: {VERSION} | <a href="https://github.com/nicorenard/streamlit-dashboard-rodez-city-hall" target="_blank">Source projet - Github</a></p>
